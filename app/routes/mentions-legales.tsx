			...
			<div className="prose prose-blue max-w-none text-gray-600 space-y-8">
				<section>
					<h2 className="text-2xl font-bold text-text-base mb-4">
						1. Éditeur de l'association
					</h2>
					<p>
						L'association Diab&Team 26-07 (Association des familles Drôme
						Ardèche) est une association loi 1901 à but non lucratif.
					</p>
					<p>
						<strong>Siège social :</strong> Maison de la Vie Associative, 26000
						Valence
						<br />
						<strong>Email :</strong> diabeteam2607@gmail.com
						<br />
						<strong>Téléphone :</strong> 07 82 12 01 63
					</p>
				</section>

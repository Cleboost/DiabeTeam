		...
		<div className="container-responsive py-12 md:py-20">
			...
			<div className="prose prose-gray max-w-none space-y-8">
				<section>
					...
					<p>
						Le site internet <strong>diabeteam.fr</strong> ainsi que l'ensemble
						de ses sous domaines est édité par l'association{" "}
						<strong>Diab&Team 26-07</strong>.<br />
						{/* Association loi 1901 affiliée à l'AJD (Aide aux Jeunes Diabétiques). */}
					</p>
					<ul className="list-disc pl-5 mt-2 space-y-1">
						<li>
							<strong>Siège social :</strong> Centre Hospitalier de Valence,
							service Pédiatrie. 179 bd maréchal juin 26000 Valence
						</li>
						<li>
							<strong>Email :</strong> diabeteam2607@gmail.com
						</li>
						<li>
							<strong>Directeur de la publication :</strong> Vincent
						</li>
					</ul>
				</section>
				...
				<section>
					...
					<ul className="list-disc pl-5 mt-2 space-y-1">
						<li>
							<strong>Conception et réalisation :</strong> Clément Balarot
						</li>
						<li>
							<strong>Photos :</strong> Diab&Team 26-07
						</li>
						<li>

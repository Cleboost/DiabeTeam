	...
	return (
		<div className="container-responsive py-12 md:py-20">
			...
			<p className="text-center text-gray-600 mb-12 max-w-2xl mx-auto">
				Une question sur l'association, une demande de partenariat ou simplement
			...
			<div className="max-w-3xl mx-auto space-y-8">
				...
				<Card className="p-8 flex flex-col md:flex-row items-center gap-6 text-center md:text-left">
					...
					<div className="flex-1">
						...
						<p className="text-gray-600">
							...
							Nos actions rayonnent sur toute la <strong>Drôme</strong> et l'
							<strong>Ardèche</strong>.
						</p>
					</div>
				</Card>
				...
				<div className="bg-accent/10 p-6 rounded-2xl border border-accent/20 text-center">
					...
					<p className="text-gray-700">
						L'association ne remplace pas une consultation médicale. En cas
						d'urgence médicale liée au diabète, contactez le <strong>15</strong>{" "}
						ou votre service hospitalier référent.
					</p>
				</div>
			</div>
		</div>

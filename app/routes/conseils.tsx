...
import { Info, ShieldAlert, Heart, Lightbulb, ExternalLink } from "lucide-react";
      ...
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600">
            Vous n'êtes pas seuls. Voici quelques premières pistes pour vous aider à y voir plus clair.
          </p>
        </div>
        ...
        <div className="space-y-12">
          ...
          <section>
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 className="text-2xl font-bold text-text-base">Les premiers jours</h2>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <Card className="p-6">
                ...
                <p className="text-gray-600">
                  L'annonce est un choc. Il est normal de se sentir dépassé. Ne cherchez pas à tout maîtriser en 24h. L'apprentissage se fait étape par étape, avec l'équipe médicale.
                </p>
              </Card>
              ...
              <Card className="p-6">
                ...
                <p className="text-gray-600">
                  L'éducation thérapeutique à l'hôpital est la base. Notez toutes vos questions pour les poser aux infirmières et diabétologues.
                </p>
              </Card>
            </div>
          </section>
          ...
          <section>
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 className="text-2xl font-bold text-text-base">Astuces pratiques</h2>
            </div>
            ...
            <div className="space-y-4">
              <div className="flex gap-4 p-4 rounded-xl bg-bg-alt border border-gray-ui/50">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Toujours avoir du sucre (jus, morceaux de sucre) et de l'eau sur soi. Préparez un petit sac qui suit votre enfant partout.</p>
                </div>
              </div>
              ...
              <div className="flex gap-4 p-4 rounded-xl bg-bg-alt border border-gray-ui/50">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Le Projet d'Accueil Individualisé (PAI) est indispensable. Il permet d'organiser les soins à l'école. Nous pouvons vous aider à en discuter avec les enseignants.</p>
                </div>
              </div>
              ...
              <div className="flex gap-4 p-4 rounded-xl bg-bg-alt border border-gray-ui/50">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Applis de calcul de glucides, lecteurs de glycémie en continu... La technologie aide énormément aujourd'hui. Explorez-la dès que vous vous sentez prêts.</p>
                </div>
              </div>
            </div>
          </section>
          ...
          <section className="bg-primary/5 p-8 rounded-3xl border border-primary/10">
            <h2 className="text-2xl font-bold text-primary mb-6">Liens et ressources utiles</h2>
          ...
          <div className="text-center pt-8">
            <h3 className="text-2xl font-bold mb-4 italic">"Le diabète n'empêche rien, il demande juste de l'organisation."</h3>
            <p className="text-gray-600 mb-8">
              Besoin de parler à d'autres parents qui sont passés par là ? Nos bénévoles sont là pour vous écouter et partager leur vécu.
            </p>

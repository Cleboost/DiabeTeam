			...
			<div className="prose prose-blue max-w-none text-gray-600 space-y-6">
				<section>
					...
					<p>
						...
						protection de vos données personnelles. Cette politique détaille comment
						nous collectons et traitons vos informations.
					</p>
				</section>
				...
				<section>
					...
					<p>
						Nous collectons des données uniquement lorsque vous nous contactez par
						email, téléphone ou via nos réseaux sociaux, ou lorsque vous adhérez via
				...
				<section>
					...
					<ul className="list-disc pl-6 space-y-2">
						...
						<li>Gérer votre adhésion et vous informer des activités de l'association</li>
						<li>Vous envoyer des informations administratives ou liées aux événements</li>
					</ul>
				</section>
				...
				<section>
					...
					<p>
						...
						à des tiers. Vos données sont conservées pour la durée nécessaire à la
						réalisation des finalités pour lesquelles elles ont été collectées.
					</p>
				</section>

				<section>
					<h2 className="text-2xl font-bold text-text-base mb-4">5. Vos droits</h2>
					<p>

...
import { Calendar, Users, Heart, ArrowRight, MapPin } from "lucide-react";
    ...
    <div className="flex flex-col min-h-screen">
        ...
        <div className="container-responsive relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-xl md:text-2xl text-gray-600 mb-8 font-light">
              ...
              <span className="text-primary font-medium">Soutenir, échanger, vivre.</span>
            </p>
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="container-responsive">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-text-base mb-4">Notre mission</h2>
            <p className="text-gray-600 max-w-2xl mx-auto">
              Nous accompagnons les familles touchées par le diabète de type 1 au quotidien à travers trois piliers essentiels.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Card className="p-8 hover:shadow-md transition-shadow">
              ...
              <p className="text-gray-600">
                Rompre l'isolement en organisant des moments conviviaux pour les parents et les enfants. Partager nos expériences et nos astuces.
              </p>
            </Card>
            ...
            <Card className="p-8 hover:shadow-md transition-shadow">
              ...
              <p className="text-gray-600">
                Être présent dans les moments difficiles (découverte, école, adolescence) et faciliter la vie avec le DT1.
              </p>
            </Card>
            ...
            <Card className="p-8 hover:shadow-md transition-shadow">
              ...
              <p className="text-gray-600">
                Informer le grand public et les structures pour mieux accueillir et comprendre le diabète de type 1.
              </p>
            </Card>
          </div>
        </div>
      ...
      <section className="py-16 md:py-24 bg-bg-alt">
        <div className="container-responsive">
          <div className="flex flex-col md:flex-row justify-between items-end mb-12 gap-4">
            <div>
              <h2 className="text-3xl font-bold text-text-base mb-2">Prochains événements</h2>
              <p className="text-gray-600">Ne manquez pas nos prochains rendez-vous !</p>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {nextEvents.map((event) => (
              <Card key={event.id} className="flex flex-col h-full hover:shadow-md transition-all hover:-translate-y-1 duration-300">
      ...
      <section className="py-16 bg-white border-t border-gray-ui/30">
        <div className="container-responsive text-center">
          <h2 className="text-2xl font-bold text-gray-400 mb-8 uppercase tracking-widest text-sm">Ils nous soutiennent</h2>
      ...
      <section className="py-20 bg-primary text-white text-center">
        <div className="container-responsive">
          <h2 className="text-3xl md:text-4xl font-bold mb-6">Envie de nous rejoindre ?</h2>
          <p className="text-white/90 text-lg max-w-2xl mx-auto mb-10">
            Que vous soyez une famille concernée ou un sympathisant, votre soutien est précieux pour faire avancer nos actions.
          </p>

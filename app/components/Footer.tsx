		...
		<footer className="bg-gray-50 border-t border-gray-ui/50 pt-16 pb-8">
			<div className="container-responsive grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
				...
				<div className="col-span-1 md:col-span-2">
					...
					<p className="text-gray-600 mb-6 max-w-sm">
						Association des familles d'enfants diabétiques de type 1. Soutenir,
						échanger, sensibiliser et vivre pleinement. Affiliée à l'AJD.
					</p>
				...
				<div>
					...
					<ul className="space-y-3">
						...
						<li>
							...
							>
								<Heart size={16} className="text-red-500 fill-red-500" /> Faire
								un don
							</Link>
						</li>
					</ul>
			...
			<div className="container-responsive pt-8 border-t border-gray-ui/50 flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-gray-500">
				...
				<p className="flex items-center gap-1">
					Fait avec <Heart size={12} className="text-red-500 fill-red-500" />{" "}
					par{" "}
					<a
						href="https://github.com/cleboost"
						target="_blank"
						rel="noopener noreferrer"
